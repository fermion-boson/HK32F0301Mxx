...
/** @defgroup PWR_Group4 VTEST configuration functions
 *  @brief   VTEST configuration functions 
 *
@verbatim
  ==============================================================================
                       ##### VTEST configuration functions #####
  ==============================================================================
...
@endverbatim
  ...
  */
/**
  * @brief  select the VREF_TEST voltage output.
  * @param  VTEST_Sel: internal Refernce out voltage  ,
  *   This parameter can be one of the following values:
			  @arg 	PWR_VTEST_LDO_CORE
				@arg	PWR_VTEST_MBGP    
				@arg	PWR_VTEST_LPLDO   
				@arg	PWR_VTEST_LPBGP   				
  * @retval None
...
{
     /* Check the parameters */
  assert_param(IS_PWR_VTEST_SEL(VTEST_Sel));

	/* select the LDO Voltage reference register */
	PWR->VREF_SEL &= ~ PWR_VREF_SEL_VTEST_SEL;

	/* set the Register*/
	PWR->VREF_SEL |= ((uint32_t)VTEST_Sel<<PWR_VREF_SEL_VTEST_SEL_Pos);
