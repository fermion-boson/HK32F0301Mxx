...
/**
  ...
  *             @arg OB_WRP_Pages0to32..OB_WRP_Pages60to63
  *             @arg OB_WRP_AllPages
  *             @arg OB_WRP_None
  * @retval FLASH Status: The returned value can be:
  *         FLASH_ERROR_PROGRAM, FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
...
FLASH_Status FLASH_OB_WRPConfig(uint32_t OB_WRP)
{
  ...
  WRP0_Data = (uint16_t)(OB_WRP & WRP0_Mask);
  WRP1_Data = (uint16_t)((OB_WRP & WRP1_Mask) >> 8);
  WRP2_Data = (uint16_t)((OB_WRP & WRP2_Mask) >> 16);
  WRP3_Data = (uint16_t)((OB_WRP & WRP3_Mask) >> 24);
  ...
  { 
    ...
    if(WRP0_Data != 0xFF)
    { 
		OB->WRP01 = (uint32_t)(0x0000FFFF & WRP0_Data); 
    ...
    { 
		OB->WRP01 = (uint32_t)(0x0000FFFF &(WRP1_Data<<8));
    ...
    { 
		OB->WRP23 = (uint32_t)(0x0000FFFF & (WRP2_Data<<16));
    ...
    { 
		OB->WRP23 = (uint32_t)(0x0000FFFF & (WRP3_Data<<24));
