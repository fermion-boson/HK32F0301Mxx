...
/*********************************** PWR->VREF_SEL  *************************************/
#define PWR_VREF_SEL_VTEST_SEL_Pos            ((uint32_t)13)                    /* Voltage test set */
#define PWR_VREF_SEL_VTEST_SEL_Mask           (((uint32_t)0x07) << 13)
#define PWR_VREF_SEL_VTEST_SEL                PWR_VREF_SEL_VTEST_SEL_Mask
#define PWR_VREF_SEL_VTEST_SEL_0              (((uint32_t)0x1 << PWR_VREF_SEL_VTEST_SEL_Pos))
#define PWR_VREF_SEL_VTEST_SEL_1              (((uint32_t)0x2 << PWR_VREF_SEL_VTEST_SEL_Pos))
#define PWR_VREF_SEL_VTEST_SEL_2              (((uint32_t)0x4 << PWR_VREF_SEL_VTEST_SEL_Pos))
