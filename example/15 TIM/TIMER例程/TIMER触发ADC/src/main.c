...
void TIM_Config(void)
{
  ...
  TIM_TimeBaseStructure.TIM_Period = 1000;//ARR=1000,则1000/1000=1S
  TIM_TimeBaseStructure.TIM_Prescaler = 48000;  //sysclk=48M，48000分频则CNT为1000HZ	
  ...
  TIM_OCInitStructure.TIM_Pulse = 500;//每1S第500个CNT计数时刻产生一个触发信号
