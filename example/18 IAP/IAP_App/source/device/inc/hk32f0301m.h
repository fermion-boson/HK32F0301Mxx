...
#if !defined (HK32F0301MJ4M6) && !defined (HK32F0301MD4P6) && !defined (HK32F0301MF4P6) && !defined (HK32F0301MF4U6) 
  #error "Please select first the target HK32F0301M device used in your application"
#endif
...
/******  HK32F0301M specific Interrupt Numbers ******************************************************************/
...
#include "system_hk32f0301m.h"                   /*!< hk32f0301m System                                                          */
...
typedef struct
{
  ...
  __IO uint32_t DR;           /*!< ADC group regular data register,               Address offset: 0x40 */
	...
	__IO uint32_t CR2;          /*!< ADC control register 2                         Address offset: 0x3f0 */
} ADC_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t PKG_PIN_SEL;         /*!<GPIO IOMUX Pin Function select register of  different package ,     Address offset: 0x04      */
...
typedef struct
{
  ...
  __IO uint32_t RESERVED1[11];  /* reserved    											                  padding 0x08-0x30    */
  __IO uint32_t WUP_POL;   		  /*!< PWR wake up pin polarity control register,      	  Address offset: 0x34 */
  __IO uint32_t RESERVED2;  	  /* reserved    											                    padding 0x38         */
  __IO uint32_t PORPDR_CFG;  	  /*!< PWR power down  configer register in standby,   	  Address offset: 0x3C */
  __IO uint32_t RESERVED3[10];  /* reserved    											                  padding 0x40-0x64    */
  __IO uint32_t VREF_SEL;   	/*!< PWR power LDO voltage reference configer register,     				    Address offset: 0x68 */
  __IO uint32_t RESERVED4[12];  /* reserved    											                  padding 0x6c-0x98    */
  __IO uint32_t SAWUT;  			  /*!< PWR Standby wakeup Timer control register,           Address offset: 0x9c */
  __IO uint32_t SBKP0;   		    /*!< PWR backup 0 register for standby,                   Address offset: 0xa0 */
  __IO uint32_t SBKP1;  		    /*!< PWR backup 1 register for standby,                   Address offset: 0xa4 */
} PWR_TypeDef;
...
#define PWR_CSR_LDORDY_Pos         (3U)                                        
#define PWR_CSR_LDORDY_Msk         (0x1U << PWR_CSR_LDORDY_Pos)                   /*!< 0x00000004 */
#define PWR_CSR_LDORDY             PWR_CSR_LDORDY_Msk                             /*!< LDO Flag */

#define PWR_CSR_EWUP1_Pos          (8U)                                        
#define PWR_CSR_EWUP1_Msk          (0x1U << PWR_CSR_EWUP1_Pos)                 /*!< 0x00000100 */
#define PWR_CSR_EWUP1              PWR_CSR_EWUP1_Msk                           /*!< Enable WKUP pin 1 */

#define PWR_CSR_SAWU_Pos          (15U)                                        
#define PWR_CSR_SAWU_Msk          (0x1U << PWR_CSR_SAWU_Pos)                 /*!< 0x00008000 */
#define PWR_CSR_SAWU              PWR_CSR_SAWU_Msk                           /*!< Enable SAWU  */

/*******************  Bit definition for PWR_WUP_POL register  *******************/
#define PWR_WUP_POL_WUPOL1_Pos     (0U)                                        
#define PWR_WUP_POL_WUPOL1_Msk     (0x1U << PWR_WUP_POL_WUPOL1_Pos)             /*!< 0x00000001 */
#define PWR_WUP_POL_WUPOL1         PWR_WUP_POL_WUPOL1_Msk                       /*!< Wakeup Pin1 polarity  */

/*******************  Bit definition for PWR_PORPDR_CFG register  *******************/
#define PWR_PORPDR_CFG_PDR_PD_Pos  (0U)                                        
#define PWR_PORPDR_CFG_PDR_PD_Msk  (0x1U << PWR_PORPDR_CFG_PDR_PD_Pos)         /*!< 0x00000001 */
#define PWR_PORPDR_CFG_PDR_PD      PWR_PORPDR_CFG_PDR_PD_Msk                    /*!< PDR enable  */

#define PWR_PORPDR_CFG_KEY_Pos     (8U)                                        
#define PWR_PORPDR_CFG_KEY_Msk     (0x15U << PWR_PORPDR_CFG_KEY_Pos)         /*!< 0x0000FF00 */
#define PWR_PORPDR_CFG_KEY         PWR_PORPDR_CFG_KEY_Msk                    /*!< key of unlock PDR configer  */
...
/*******************  Bit definition for PWR_SAWUT register  *******************/
#define PWR_WUP_SAWUT_Pos     (0U)                                        
#define PWR_WUP_SAWUT_Msk     (0x15U << PWR_WUP_SAWUT_Pos)             /*!< 0x000000FF */
#define PWR_WUP_SAWUT         PWR_WUP_SAWUT_Msk                       /*!< Standby Wakeup Timer  */

/*******************  Bit definition for PWR_SBKP0 register  *******************/
#define PWR_SBKP0_Pos        (0U)                                        
#define PWR_SBKP0_Msk        (0x15U << PWR_SBKP0_Pos)             /*!< 0x000000FF */
#define PWR_SBKP0            PWR_SBKP0_Msk                       /*!< Standby Wakeup Timer  */

/*******************  Bit definition for PWR_SBKP1 register  *******************/
#define PWR_SBKP1_Pos         (0U)                                        
#define PWR_SBKP1_Msk         (0x15U << PWR_SBKP1_Pos)             /*!< 0x000000FF */
#define PWR_SBKP1             PWR_SBKP1_Msk                       /*!< Standby Wakeup Timer  */
...
/******************************************************************************/
/*  For a painless codes migration between the HK32F0301M device product       */
/*  lines, the aliases defined below are put in place to overcome the         */
/*  differences in the interrupt handlers and IRQn definitions.               */
/*  No need to update developed interrupt code when moving across             */
/*  product lines within the same HK32F0301M Family                              */
/******************************************************************************/
