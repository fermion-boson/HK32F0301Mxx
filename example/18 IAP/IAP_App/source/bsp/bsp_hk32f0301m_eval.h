/*
********************************************************************************
** @file    : bsp_hk32f0301m_eval.h
** @author  : 
** @version : v0.0.1
** @date    : 2020-02-04
** @brief   : This file contains definitions for bsp_hk32f0301m_eval's Leds, push-buttons,
**            COM ports, sFLASH(on SPI), and eeprom(on IIC) hardware resources            
********************************************************************************
*/ 
  
#ifndef __BSP_HK32F0301M_EVAL_H
#define __BSP_HK32F0301M_EVAL_H
...
#define GPIO_LED1_SPEED                  GPIO_Speed_10MHz
...
#define GPIO_LED2_SPEED                  GPIO_Speed_10MHz
...
#define GPIO_LED3_SPEED                  GPIO_Speed_10MHz
...
#define GPIO_LED4_SPEED                  GPIO_Speed_10MHz
...
#define LED595_SCK_SPEED                 GPIO_Speed_10MHz
...
#define LED595_SI_SPEED                  GPIO_Speed_10MHz
...
#define LED595_LATCH_SPEED               GPIO_Speed_10MHz
