...
/**
  ...
  *         HSE_STARTUP_TIMEOUT in hk32f0301m.h file. You can tailor it depending
  *         on the HSE crystal used in your application.
  * @note   is stopped by hardware when entering STOP and STANDBY modes.
 ...
 ===============================================================================
    ...
    [..] This section provide functions allowing to configure the System, AHB and 
        ...
        +----------------------------------------------+
         ...
         (#) After reset, the System clock source is the HSI (48 MHz)/6 with 0 WS and 
...
/**
  ...
  *         startup from Reset, wake-up from STOP and STANDBY mode.
...
/**
  ...
  *          This parameter can be one of the following values:
  *             @arg RCC_ADCCLK_HSI48M_Div1: 
  *             @arg RCC_ADCCLK_HSI48M_Div1_5

  *             @arg RCC_ADCCLK_HSI48M_Div16_5 
