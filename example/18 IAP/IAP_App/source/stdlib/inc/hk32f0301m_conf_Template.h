/**
  ******************************************************************************
  * @file    hk32f0301m_conf_Template.h
  * @brief   hk32f0301m configuration file of backup.
  ******************************************************************************
  * @attention 
...
#ifndef __HK32F0301M_CONF_H
#define __HK32F0301M_CONF_H
...
/**
 ...
 #include "hk32f0301m_crc.h"

 #include "hk32f0301m_exti.h"

 #include "hk32f0301m_flash.h"

 #include "hk32f0301m_gpio.h"

 #include "hk32f0301m_misc.h"

 #include "hk32f0301m_adc.h"

 #include "hk32f0301m_syscfg.h"

 #include "hk32f0301m_def.h"
 #include "hk32f0301m_i2c.h"

 #include "hk32f0301m_iwdg.h"

 #include "hk32f0301m_pwr.h"

 #include "hk32f0301m_spi.h"

 #include "hk32f0301m_tim.h"

 #include "hk32f0301m_usart.h"

 #include "hk32f0301m_iwdg.h"

 #include "hk32f0301m_wwdg.h"

 #include "hk32f0301m_awu.h"
 
 #include "hk32f0301m_beep.h"
/* Exported macro ------------------------------------------------------------*/
