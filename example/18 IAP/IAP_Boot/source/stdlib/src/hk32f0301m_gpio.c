...
/**
  ...
  *          This parameter can be one of the following value:
  *           GPIOMUX_AF3_TIM1CH3 
              GPIOMUX_AF3_TIM1CH1N
              GPIOMUX_AF3_TIM1CH4 
              GPIOMUX_AF3_TIM1CH2N
							GPIOMUX_AF0_SWCLK         
							GPIOMUX_AF0_I2C_SDA       
  * @retval None
  */
...
void GPIO_IOMUX_ChangePin(IOMUX_PIN eIOMUX_Pinx, uint32_t IOMUX_FuncPin)
{
  ...
  switch (eIOMUX_Pinx)
  {
    ...
    case IOMUX_PIN2://TSSOP16 TSSOP20 
      #if defined (HK32F0301MD4P6) || defined (HK32F0301MF4P6) 
